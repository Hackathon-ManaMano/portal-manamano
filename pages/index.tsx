...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="grid flex-column mt-0 text-indigo-900 bg-contain line-height-3" style={{background: `url(${"/home-clareada.jpg"})`}}>
        ...
        <div className="field col-8 col-offset-2 text-center text-2xl">
            <p> Ao apoiar o Fundo MANAMANO você contribui para a formação
       ...
       <div className="flex flex-row col-12">
        ...
        <div className="grid p-4 align-items-center">
          <div className="col-12 md:col-6 flex flex-column text-xl text-center"> 
            ...
            <p className="-mt-3 ml-5"> O Fundo trabalha com nano e micro empreendedoras(es) de regiões 
